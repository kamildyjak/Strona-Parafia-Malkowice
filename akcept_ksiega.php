...
<?php
	...
	$sql_remove = "UPDATE ksiega_gosci SET ok='tak' WHERE id='$id'";
	if($conn->query($sql_remove)==TRUE){
		echo 'komunikat_ok("Wpis został zaakceptowany !");
		setTimeout(function(){window.location="ksiega_list_akcept.php";},2000)';
	}else{
